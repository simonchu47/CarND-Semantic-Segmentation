    ...
    def get_batches_fn(batch_size):
        ...
        for batch_i in range(0, len(image_paths), batch_size):
            ...
            for image_file in image_paths[batch_i:batch_i+batch_size]:
                #print("file name is {}".format(os.path.basename(image_file)))
                #print("label_paths is {}".format(label_paths))
                #print("image_paths is {}".format(image_paths))
                ...
                gt_image_shape = (image.shape[0], image.shape[1], num_classes)
